...
who are unsettled about whether |pygtkmvc3| can fit their needs or not.
...
|pygtkmvc3| has been extensively used to produce a few large |obs|
applications based on |python| and |pygtk|. In this scenario, many
design choices that led to |pygtkmvc3| had been determined from
