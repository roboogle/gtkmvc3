...
version = '.'.join(map(str, gtkmvc3.get_version()[0:2]))
# The full version, including alpha/beta/rc tags.
release = '.'.join(map(str, gtkmvc3.get_version()))
...
latex_documents = [
  ('quickstart/index', 'gtkmvc3-quickstart.tex', u'gtkmvc3: A Quickstart Guide',
   u'Roberto Cavada', 'manual'),
  ('tutorial/index', 'gtkmvc3-tutorial.tex', u'Tutorial Documentation',
   u'Roberto Cavada', 'manual'),
  ('manual/index', 'gtkmvc3-userman.tex', u'Model-View-Controller and Observer patterns for PyGTK Documentation',
   u'Roberto Cavada', 'manual'),
  ('api/index', 'gtkmvc3-reference.tex', u'GTK MVC Library Reference',
   u'Roberto Cavada', 'manual'),
]
