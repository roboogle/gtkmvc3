...
|gtkmvc| is a thin framework for supporting GUI programming with
Python (2 and 3) and GTK3 thought GObject Introspection. Its major
features are:
   ...
   #. Guides the design and the structure to your application, still
      being behind the scene.
   #. |gtkmvc| is small: you can distribute it along with your
...
|gtkmvc| plays a rule to help designers to correctly structure their
