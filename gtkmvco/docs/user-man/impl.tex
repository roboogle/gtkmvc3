...
\item[controller] This parameter is provided for compatibility with
  old versions of \gtkmvc. Now the view is passed when creating the
  Controller, so this parameter should be not used in new code. 
...
the derived view method setup\_widgets that is automatically called
by the View's constructor:
