...
class MyCtrl (Controller):
    ...
    def register_view(self, view):
        view['window_top'].connect('delete-event', self.quit)

        view.setup_content(self.model.counter_names,
                           self.model.get_max_value())
        return
    ...
    def register_adapters(self):
        ...
        # this is done to add some cosmetics to the label showinf 'counter_select':
