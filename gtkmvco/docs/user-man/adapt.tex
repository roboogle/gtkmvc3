...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=10cm]{figs/png/adap.png}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=10cm]{figs/png/adap1.png}
...
\begin{figure}[here]
\begin{center}
\includegraphics[width=7cm]{figs/png/adapuml.png}
...
\file{adapters.default}. The module exports two functions to add and
remove default adapters at runtime. These function are:
\begin{description}
  \item[add\_adapter] to add a new default adapter.
  \item[remove\_adapter] to remove a default adapter.
\end{description}
...
\begin{figure}[here]
\begin{center}
\includegraphics[width=4cm]{figs/png/adap2.png}
...
\begin{figure}[here]
\begin{center}
\includegraphics[width=4cm]{figs/png/adap3.png}
...
\codename{gtk.ToggleButton} &  \codename{types.BooleanType} & Current
toggle state \\
\codename{gtk.FileChooserButton} & \codename{types.StringType} &
Selected file name \\ 
\codename{gtk.ComboBox} & \codename{types.IntType} & Model index of
...
\codename{adapters.default} and functions
\codename{adapters.default.add\_adapter} and
\codename{adapters.default.remove\_adapter}.
